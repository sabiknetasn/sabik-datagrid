...
import "C:/Projects/TableComponent/phase1-verify-app/node_modules/sabik-datagrid/dist/index.css";
...
//#endregion
//#region node_modules/sabik-datagrid/dist/index.mjs
var D = {
...
var Xe = (e, t, r) => {
	if (r == null || r === "") return true;
	let o = e.getValue(t), s = Number(o), n = Number(r);
	return Number.isNaN(n) ? true : !Number.isNaN(s) && s === n;
};
var Ze = (e, t, r) => {
	if (r == null || r === "" || r === "all") return true;
	let o = e.getValue(t);
	return r === "true" ? o === true || o === "true" : r === "false" ? o === false || o === "false" : true;
};
var ce = {
	sdgString: Je,
	sdgNumberEquals: Xe,
...
function me(e) {
	switch (e) {
		case "number": return "sdgNumberEquals";
		case "boolean": return "sdgBoolean";
		default: return "sdgString";
	}
}
function pe(e) {
	if (!e) return {
...
function ue(e) {
	if (!e) return {};
	let t = {};
	return e.primary && (t["--sdg-primary"] = e.primary), e.background && (t["--sdg-bg"] = e.background), e.headerBackground && (t["--sdg-header-bg"] = e.headerBackground), e.border && (t["--sdg-border"] = e.border, t["--sdg-input"] = e.border), e.radius && (t["--sdg-radius"] = e.radius), t;
}
function Y(e, t) {
	return e ?? D.DEFAULT_ROW_HEIGHT[t];
}
var $ = (e, t, r) => {
	let o = e ? `${D.STORAGE_KEY_PREFIX}${e}:${t}` : null;
	return {
		load: () => {
			if (!o) return r;
			try {
				...
				return console.error(`Error loading persistence for ${t}:`, a), r;
			}
		},
		save: (a) => {
			if (o) try {
				...
				console.error(`Error saving persistence for ${t}:`, d);
			}
		}
	};
};
var fe = (0, import_react.createContext)(null);
var ve = ({ children: e, persistenceKey: t, initialState: r, density: o, appearance: s = {}, theme: n }) => {
	let a = $(t, "sorting", []), d = $(t, "filters", []), l = $(t, "visibility", {}), m = $(t, "pagination", {
		pageIndex: 0,
		pageSize: 10
	}), [v, p] = (0, import_react.useState)(() => t ? a.load() : r?.sorting || []), [u, y] = (0, import_react.useState)(() => t ? d.load() : r?.columnFilters || []), [x, A] = (0, import_react.useState)(r?.globalFilter || ""), [w, z] = (0, import_react.useState)(() => t ? l.load() : r?.columnVisibility || {}), [R, F] = (0, import_react.useState)(r?.rowSelection || {}), [b, S] = (0, import_react.useState)(() => t ? m.load() : r?.pagination || {
		pageIndex: 0,
		pageSize: 10
	}), [V, B] = (0, import_react.useState)(o ?? "comfortable");
	(0, import_react.useEffect)(() => {
		o && B(o);
	}, [o]), (0, import_react.useEffect)(() => {
		t && (a.save(v), d.save(u), l.save(w), m.save(b));
	}, [
		v,
		u,
		w,
	...
	let O = (0, import_react.useMemo)(() => ue(n), [n]), U = (0, import_react.useMemo)(() => ({
		state: {
			sorting: v,
			columnFilters: u,
			globalFilter: x,
		...
		setSorting: (h) => p(h),
		setColumnFilters: (h) => y(h),
		setGlobalFilter: (h) => A(h),
		setColumnVisibility: (h) => z(h),
		setRowSelection: (h) => F(h),
		setPagination: (h) => S(h),
		density: V,
		setDensity: B,
		appearance: s,
	...
	return (0, import_jsx_runtime.jsx)(fe.Provider, {
		value: U,
		children: e
	});
};
var N = () => {
	let e = (0, import_react.useContext)(fe);
	if (!e) throw new Error("useDataGridContext must be used within a DataGridProvider");
	return e;
};
function ot(e) {
	return e.filterType ? e.filterType : "string";
}
function rt({ header: e }) {
	let t = e.column.columnDef, r = ot(t), o = e.column.getFilterValue(), s = (n) => n.stopPropagation();
	return r === "boolean" ? (0, import_jsx_runtime.jsxs)("select", {
		className: "sdg__col-filter sdg__col-filter--select",
		value: o == null ? "all" : String(o),
		onChange: (n) => {
			let a = n.target.value;
			e.column.setFilterValue(a === "all" ? void 0 : a);
		},
		onClick: s,
		"aria-label": `Filter ${String(t.header ?? e.id)}`,
		children: [
	...
	}) : r === "number" ? (0, import_jsx_runtime.jsx)("input", {
		type: "number",
		className: "sdg__col-filter",
		placeholder: "=",
		value: o == null ? "" : String(o),
		onChange: (n) => e.column.setFilterValue(n.target.value || void 0),
		onClick: s,
		"aria-label": `Filter ${String(t.header ?? e.id)}`
...
function he({ table: e, filterable: t, stickyHeader: r }) {
	let { density: o } = N(), s = D.DENSITY_CLASSES[o];
	return (0, import_jsx_runtime.jsx)("thead", {
		className: `sdg__thead ${r ? "sdg__thead--sticky" : ""}`,
		children: e.getHeaderGroups().map((n) => (0, import_jsx_runtime.jsxs)(import_react.Fragment, { children: [(0, import_jsx_runtime.jsx)("tr", {
			className: "sdg__header-row",
			children: n.headers.map((a) => {
				let d = a.column.columnDef, l = a.column.getCanSort() && d.sortable !== false;
				return (0, import_jsx_runtime.jsxs)("th", {
					colSpan: a.colSpan,
					className: `sdg__th ${s}`,
					style: { width: a.getSize() },
					children: [(0, import_jsx_runtime.jsxs)("div", {
						className: `sdg__th-inner ${l ? "sdg__th-inner--sortable" : ""}`,
						onClick: l ? a.column.getToggleSortingHandler() : void 0,
						onKeyDown: l ? (m) => {
							(m.key === "Enter" || m.key === " ") && (m.preventDefault(), a.column.getToggleSortingHandler()?.(m));
						} : void 0,
						role: l ? "button" : void 0,
						tabIndex: l ? 0 : void 0,
						children: [(0, import_jsx_runtime.jsx)("span", {
							className: "sdg__th-label",
							children: flexRender(a.column.columnDef.header, a.getContext())
						}), l && (0, import_jsx_runtime.jsxs)("div", {
							className: "sdg__sort",
							"aria-hidden": "true",
							children: [(0, import_jsx_runtime.jsx)("span", {
								className: a.column.getIsSorted() === "asc" ? "sdg__sort-active" : "",
								children: "▲"
							}), (0, import_jsx_runtime.jsx)("span", {
								className: a.column.getIsSorted() === "desc" ? "sdg__sort-active" : "",
								children: "▼"
							})]
						})]
		...
		}), t && (0, import_jsx_runtime.jsx)("tr", {
			className: "sdg__filter-row",
			children: n.headers.map((a) => {
				let d = a.column.columnDef, m = !(a.column.id === "selection") && d.filterable !== false;
				return (0, import_jsx_runtime.jsx)("th", {
					colSpan: a.colSpan,
					className: `sdg__th sdg__th--filter ${s}`,
					style: { width: a.getSize() },
					children: m ? (0, import_jsx_runtime.jsx)(rt, { header: a }) : null
				}, `${a.id}-filter`);
			})
		})] }, n.id))
	});
}
var q = ({ row: e, actions: t }) => {
	let [r, o] = import_react.useState(false);
	return (0, import_jsx_runtime.jsxs)("div", {
		className: "sdg__actions",
		children: [(0, import_jsx_runtime.jsx)("button", {
			...
			"aria-expanded": r,
			children: "⋮"
		}), r && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("div", {
			className: "sdg__actions-backdrop",
			onClick: (s) => {
				s.stopPropagation(), o(false);
			}
		}), (0, import_jsx_runtime.jsx)("div", {
			className: "sdg__actions-menu",
			role: "menu",
			children: t.map((s, n) => (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				role: "menuitem",
				disabled: s.disabled,
				onClick: (a) => {
					a.stopPropagation(), s.onClick(e.original), o(false);
				},
				className: `sdg__actions-item ${s.danger ? "sdg__actions-item--danger" : ""}`,
...
function dt(e, t, r) {
	let o = ["sdg__tr"];
	return t && o.push("sdg__tr--zebra"), r && o.push("sdg__tr--hoverable"), e && o.push("sdg__tr--selected"), o.join(" ");
}
function ye({ table: e, onRowClick: t, onRowDoubleClick: r, rowActions: o }) {
	let { density: s, appearance: n } = N(), a = D.DENSITY_CLASSES[s], d = Y(n.rowHeight, s), l = n.striped ?? false, m = n.hoverable ?? false, v = (0, import_react.useMemo)(() => n.rowHeight ? { height: `${d}px` } : void 0, [n.rowHeight, d]);
	return (0, import_jsx_runtime.jsx)("tbody", {
		className: "sdg__tbody",
		children: e.getRowModel().rows.map((p) => (0, import_jsx_runtime.jsxs)("tr", {
			onClick: () => t?.(p.original),
			onDoubleClick: () => r?.(p.original),
			className: dt(p.getIsSelected(), l, m),
			style: v,
			role: "row",
			"aria-selected": p.getIsSelected(),
			children: [p.getVisibleCells().map((u) => (0, import_jsx_runtime.jsx)("td", {
				className: `sdg__td ${a}`,
				role: "cell",
				children: flexRender(u.column.columnDef.cell, u.getContext())
			}, u.id)), o && o.length > 0 && (0, import_jsx_runtime.jsx)("td", {
				className: `sdg__td sdg__td--actions ${a}`,
...
function we({ table: e, scrollElement: t, onRowClick: r, onRowDoubleClick: o, rowActions: s }) {
	let { density: n, appearance: a } = N(), d = D.DENSITY_CLASSES[n], l = Y(a.rowHeight, n), m = a.striped ?? false, v = a.hoverable ?? false, { rows: p } = e.getRowModel(), u = useVirtualizer({
		count: p.length,
		getScrollElement: () => t,
		estimateSize: () => l,
		overscan: 8,
		enabled: !!t
	}), y = u.getVirtualItems(), x = u.getTotalSize(), A = y.length > 0 ? y[0].start : 0, w = y.length > 0 ? x - y[y.length - 1].end : 0, z = e.getVisibleLeafColumns().length + (s?.length ? 1 : 0), R = (0, import_react.useMemo)(() => ({ minHeight: `${l}px` }), [l]);
	return (0, import_jsx_runtime.jsxs)("tbody", {
		className: "sdg__tbody",
		children: [
			A > 0 && (0, import_jsx_runtime.jsx)("tr", {
				"aria-hidden": "true",
			...
			y.map((F) => {
				...
				return (0, import_jsx_runtime.jsxs)("tr", {
					...
					onClick: () => r?.(b.original),
					onDoubleClick: () => o?.(b.original),
					className: pt(b.getIsSelected(), m, v),
					role: "row",
					"aria-selected": b.getIsSelected(),
					style: {
						...R,
						height: `${F.size}px`
					},
					children: [b.getVisibleCells().map((S) => (0, import_jsx_runtime.jsx)("td", {
						className: `sdg__td ${d}`,
						style: { width: S.column.getSize() },
						role: "cell",
						children: flexRender(S.column.columnDef.cell, S.getContext())
					}, S.id)), s && s.length > 0 && (0, import_jsx_runtime.jsx)("td", {
						className: `sdg__td sdg__td--actions ${d}`,
						children: (0, import_jsx_runtime.jsx)(q, {
							row: b,
							actions: s
						})
			...
			w > 0 && (0, import_jsx_runtime.jsx)("tr", {
				"aria-hidden": "true",
				children: (0, import_jsx_runtime.jsx)("td", {
					colSpan: z,
					style: {
...
var Se = ({ table: e }) => (0, import_jsx_runtime.jsxs)("div", {
	className: "sdg__pagination",
	children: [(0, import_jsx_runtime.jsxs)("div", {
		className: "sdg__pagination-meta",
		children: [
			(0, import_jsx_runtime.jsx)("span", { children: "Page" }),
			(0, import_jsx_runtime.jsx)("span", {
				className: "sdg__page-num",
				children: e.getState().pagination.pageIndex + 1
			}),
			(0, import_jsx_runtime.jsx)("span", { children: "of" }),
			(0, import_jsx_runtime.jsx)("span", {
				className: "sdg__page-num",
		...
		className: "sdg__pagination-controls",
		children: [(0, import_jsx_runtime.jsx)("select", {
			...
			children: [
				...
				50,
				100
			].map((t) => (0, import_jsx_runtime.jsxs)("option", {
				value: t,
				children: [t, " rows / page"]
			}, t))
		}), (0, import_jsx_runtime.jsxs)("div", {
			className: "sdg__toolbar-group",
			children: [(0, import_jsx_runtime.jsx)("button", {
				type: "button",
...
var ke = ({ table: e }) => (0, import_jsx_runtime.jsxs)("div", {
	className: "sdg__menu",
	children: [(0, import_jsx_runtime.jsx)("p", {
		className: "sdg__menu-title",
		children: "Toggle Columns"
	}), (0, import_jsx_runtime.jsx)("div", {
		className: "sdg__menu-list",
		children: e.getAllLeafColumns().map((t) => (0, import_jsx_runtime.jsxs)("label", {
			className: "sdg__menu-item",
			children: [(0, import_jsx_runtime.jsx)("input", {
				type: "checkbox",
				className: "sdg__checkbox",
				checked: t.getIsVisible(),
				onChange: t.getToggleVisibilityHandler()
			}), String(t.columnDef.header ?? t.id)]
		}, t.id))
	})]
});
var Ce = ({ table: e, searchable: t, filterable: r, exportable: o, onExport: s }) => {
	let [n, a] = import_react.useState(false);
	return (0, import_jsx_runtime.jsxs)("div", {
		className: "sdg__toolbar",
		children: [
			(0, import_jsx_runtime.jsx)("div", {
				className: "sdg__toolbar-group",
				children: t && (0, import_jsx_runtime.jsxs)("div", {
					className: "sdg__search",
					children: [(0, import_jsx_runtime.jsx)("div", {
						className: "sdg__search-icon",
						...
						value: e.getState().globalFilter || "",
						onChange: (d) => e.setGlobalFilter(d.target.value),
			...
			(0, import_jsx_runtime.jsxs)("div", {
				className: "sdg__toolbar-group",
				children: [
					r && (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						onClick: () => e.setColumnFilters([]),
						className: "sdg__btn",
			...
			n && (0, import_jsx_runtime.jsx)(ke, { table: e })
		]
	});
};
var Te = ({ customLoadingState: e }) => (0, import_jsx_runtime.jsx)("div", {
	className: "sdg__status",
	children: e || (0, import_jsx_runtime.jsxs)("div", {
		className: "sdg__toolbar-group",
		style: { flexDirection: "column" },
		children: [(0, import_jsx_runtime.jsx)("div", { className: "sdg__spinner" }), (0, import_jsx_runtime.jsx)("p", {
			className: "sdg__status-text",
			children: "Loading data..."
		})]
	})
});
var Ne = ({ customEmptyState: e }) => (0, import_jsx_runtime.jsx)("div", {
	className: "sdg__status",
	children: e || (0, import_jsx_runtime.jsx)("div", {
		className: "sdg__status-text",
		children: (0, import_jsx_runtime.jsx)("p", { children: "No records found" })
	})
});
var Re = ({ error: e, customErrorState: t }) => (0, import_jsx_runtime.jsx)("div", {
	className: "sdg__status",
	children: t || (0, import_jsx_runtime.jsxs)("div", {
		className: "sdg__status-error",
		children: [(0, import_jsx_runtime.jsx)("p", {
...
var Fe = ({ table: e, actions: t, onBulkAction: r }) => {
	let o = e.getSelectedRowModel().rows.map((s) => s.original);
	return o.length === 0 ? null : (0, import_jsx_runtime.jsxs)("div", {
		className: "sdg__bulk",
		children: [(0, import_jsx_runtime.jsxs)("div", {
			className: "sdg__bulk-meta",
			children: [(0, import_jsx_runtime.jsx)("span", {
				className: "sdg__bulk-count",
				children: o.length
			}), (0, import_jsx_runtime.jsx)("span", { children: "rows selected" })]
		}), (0, import_jsx_runtime.jsxs)("div", {
			className: "sdg__toolbar-group",
			children: [t.map((s, n) => (0, import_jsx_runtime.jsx)("button", {
				type: "button",
				onClick: () => r(s, o),
				className: `sdg__btn ${s.danger ? "sdg__btn--danger" : ""}`,
				children: s.label
			}, n)), (0, import_jsx_runtime.jsx)("button", {
				type: "button",
				onClick: () => e.toggleAllRowsSelected(false),
...
var Ge = ({ rowCount: e = 10, colCount: t, density: r }) => {
	let o = {
		compact: "sdg__skeleton-row--compact",
		comfortable: "sdg__skeleton-row--comfortable",
		spacious: "sdg__skeleton-row--spacious"
	}[r] || "sdg__skeleton-row--comfortable";
	return (0, import_jsx_runtime.jsx)("div", {
		className: "sdg__skeleton",
		children: Array.from({ length: e }).map((s, n) => (0, import_jsx_runtime.jsx)("div", {
			className: `sdg__skeleton-row ${o}`,
			children: Array.from({ length: t }).map((a, d) => (0, import_jsx_runtime.jsx)("div", { className: "sdg__skeleton-cell" }, d))
		}, n))
	});
};
function Dt({ data: e, columns: t, loading: r, error: o, emptyState: s, loadingState: n, errorState: a, searchable: d, filterable: l, pagination: m, selectable: v, exportable: p, toolbar: u, stickyHeader: y, virtualized: x, manualPagination: A, manualSorting: w, manualFiltering: z, rowActions: R, bulkActions: F, onBulkAction: b, onRowClick: S, onRowDoubleClick: V, onSelectionChange: B, onSortChange: O, onFilterChange: U, onPaginationChange: h, onExport: Pe, className: Ae }) {
	let { state: _, setSorting: Ie, setColumnFilters: Ve, setGlobalFilter: He, setColumnVisibility: $e, setRowSelection: Le, setPagination: Me, density: Be, themeStyle: ne, appearance: ie } = N(), [H, de] = (0, import_react.useState)(false), [Oe, Ue] = (0, import_react.useState)(null), Ye = (0, import_react.useCallback)((i) => {
		Ue(i);
	}, []);
	(0, import_react.useEffect)(() => {
		let i = (g) => {
			g.key === "Escape" && H && de(false);
		};
		return window.addEventListener("keydown", i), () => window.removeEventListener("keydown", i);
	}, [H]);
	let le = (0, import_react.useMemo)(() => {
		let i = t.map((C) => {
			let T = C, We = T.filterType ?? "string", ge = l && T.filterable !== false && T.id !== "selection";
			return {
				...T,
				enableSorting: T.sortable !== false,
				enableColumnFilter: ge,
				filterFn: ge ? me(We) : void 0
			};
		});
		return v ? [{
			id: "selection",
			...
			enableSorting: false,
			header: ({ table: C }) => (0, import_jsx_runtime.jsx)("input", {
				type: "checkbox",
				className: "sdg__checkbox",
				checked: C.getIsAllPageRowsSelected(),
				onChange: C.getToggleAllPageRowsSelectedHandler(),
				ref: (T) => {
					T && (T.indeterminate = C.getIsSomePageRowsSelected());
				},
				"aria-label": "Select all rows"
			}),
			cell: ({ row: C }) => (0, import_jsx_runtime.jsx)("input", {
				type: "checkbox",
				className: "sdg__checkbox",
		...
		state: {
			sorting: _.sorting,
			columnFilters: _.columnFilters,
			globalFilter: _.globalFilter,
			columnVisibility: _.columnVisibility,
			rowSelection: _.rowSelection,
			pagination: _.pagination
		},
		onSortingChange: (i) => {
			let g = typeof i == "function" ? i(_.sorting) : i;
			Ie(g), O?.(g);
		},
		onColumnFiltersChange: (i) => {
			let g = typeof i == "function" ? i(_.columnFilters) : i;
			Ve(g), U?.(g, _.globalFilter);
		},
		onGlobalFilterChange: (i) => {
			let g = typeof i == "function" ? i(_.globalFilter) : i;
			He(g), U?.(_.columnFilters, g);
		},
		onColumnVisibilityChange: (i) => {
			let g = typeof i == "function" ? i(_.columnVisibility) : i;
			$e(g);
		},
		onRowSelectionChange: (i) => {
			let g = typeof i == "function" ? i(_.rowSelection) : i;
			Le(g), B?.(g);
		},
		onPaginationChange: (i) => {
			let g = typeof i == "function" ? i(_.pagination) : i;
			Me(g), h?.(g);
		},
		getCoreRowModel: getCoreRowModel(),
		getPaginationRowModel: x ? void 0 : getPaginationRowModel(),
		getSortedRowModel: getSortedRowModel(),
		getFilteredRowModel: getFilteredRowModel(),
		manualPagination: x ? true : A,
		manualSorting: w,
		manualFiltering: z,
		enableRowSelection: v,
		enableGlobalFilter: d
	}), qe = (0, import_react.useMemo)(() => ({
		...ne,
		...pe(ie.rowPadding)
	}), [ne, ie.rowPadding]);
	return o ? (0, import_jsx_runtime.jsx)(Re, {
		error: o,
		customErrorState: a
	}) : r ? (0, import_jsx_runtime.jsx)(Te, { customLoadingState: n || (0, import_jsx_runtime.jsx)(Ge, {
		colCount: le.length,
		density: Be
	}) }) : e.length === 0 ? (0, import_jsx_runtime.jsx)(Ne, { customEmptyState: s }) : (0, import_jsx_runtime.jsxs)("div", {
		className: `sdg ${H ? "sdg--fullscreen" : ""} ${Ae || ""}`,
		style: qe,
		children: [
			(0, import_jsx_runtime.jsxs)("div", {
				className: "sdg__chrome",
				children: [u && (0, import_jsx_runtime.jsx)(Ce, {
					table: I,
					searchable: d,
					filterable: l,
					exportable: p,
					...
					children: (0, import_jsx_runtime.jsx)("svg", {
						...
						strokeLinecap: "round",
						strokeLinejoin: "round",
						children: H ? (0, import_jsx_runtime.jsx)("path", { d: "M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7" }) : (0, import_jsx_runtime.jsx)("path", { d: "M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16V19a2 2 0 0 0 2 2h3" })
					})
				})]
			}),
			v && (0, import_jsx_runtime.jsx)(Fe, {
				table: I,
				actions: F || [],
				onBulkAction: b || (() => {})
			}),
			(0, import_jsx_runtime.jsx)("div", {
				ref: Ye,
				className: `sdg__scroll ${x ? "sdg__scroll--virtual" : ""} ${y ? "sdg__scroll--sticky-header" : ""}`,
				children: (0, import_jsx_runtime.jsxs)("table", {
					...
					children: [(0, import_jsx_runtime.jsx)(he, {
						...
						filterable: l,
						stickyHeader: y
					}), x ? (0, import_jsx_runtime.jsx)(we, {
						table: I,
						scrollElement: Oe,
						onRowClick: S,
						onRowDoubleClick: V,
						rowActions: R
					}) : (0, import_jsx_runtime.jsx)(ye, {
						table: I,
						onRowClick: S,
						onRowDoubleClick: V,
						rowActions: R
			...
			m && (0, import_jsx_runtime.jsx)(Se, { table: I })
		]
	});
}
function Zo({ density: e, rowPadding: t, rowHeight: r, striped: o, hoverable: s, theme: n, persistenceKey: a, ...d }) {
	return (0, import_jsx_runtime.jsx)(ve, {
		persistenceKey: a,
		density: e,
		appearance: (0, import_react.useMemo)(() => ({
			rowPadding: t,
			rowHeight: r,
			striped: o,
			hoverable: s
		...
		theme: n,
		children: (0, import_jsx_runtime.jsx)(Dt, { ...d })
	});
}
//#endregion
export { Zo as DataGrid };
