...
var b = {
	STORAGE_KEY_PREFIX: "company-datagrid-persistence:",
	DENSITY_CLASSES: {
		compact: "py-1 px-2 text-xs",
		comfortable: "py-2 px-4 text-sm",
		spacious: "py-4 px-6 text-base"
	},
	ZEBRA_STRIPE_CLASS: "even:bg-gray-50 dark:even:bg-slate-900",
	HOVER_CLASS: "hover:bg-blue-50 dark:hover:bg-slate-800 transition-colors"
};
var k = (e, t) => {
	let a = `${b.STORAGE_KEY_PREFIX}${e}`;
	return {
		load: () => {
			try {
				...
				return console.error(`Error loading persistence for ${e}:`, n), t;
			}
		},
		save: (n) => {
			try {
				...
				console.error(`Error saving persistence for ${e}:`, s);
			}
		}
	};
};
var j = (0, import_react.createContext)(null);
var ee = ({ children: e, persistenceKey: t, initialState: a }) => {
	let i = k("sorting", []), o = k("filters", []), n = k("visibility", {}), s = k({
		pageIndex: 0,
		pageSize: 10
	}), [c, C] = (0, import_react.useState)(() => t ? i.load() : a?.sorting || []), [u, p] = (0, import_react.useState)(() => t ? o.load() : a?.columnFilters || []), [T, M] = (0, import_react.useState)(a?.globalFilter || ""), [h, L] = (0, import_react.useState)(() => t ? n.load() : a?.columnVisibility || {}), [G, z] = (0, import_react.useState)(a?.rowSelection || {}), [y, F] = (0, import_react.useState)(() => t ? s.load() : a?.pagination || {
		pageIndex: 0,
		pageSize: 10
	}), [A, H] = (0, import_react.useState)("comfortable");
	(0, import_react.useEffect)(() => {
		t && (i.save(c), o.save(u), n.save(h), s.save(y));
	}, [
		c,
		u,
		h,
	...
	let P = (0, import_react.useMemo)(() => ({
		...
		setSorting: (g) => C(g),
		setColumnFilters: (g) => p(g),
		setGlobalFilter: (g) => M(g),
		setColumnVisibility: (g) => L(g),
		setRowSelection: (g) => z(g),
		setPagination: (g) => F(g),
		density: A,
		setDensity: H
	}), [
	...
	return (0, import_jsx_runtime.jsx)(j.Provider, {
		value: P,
		children: e
	});
};
...
var te = ({ table: e }) => {
	let { density: t } = x(), a = b.DENSITY_CLASSES[t];
	return (0, import_jsx_runtime.jsx)("thead", {
		className: "bg-muted/50 dark:bg-slate-900/50 text-muted-foreground font-medium text-xs uppercase tracking-wider",
		children: e.getHeaderGroups().map((i) => (0, import_jsx_runtime.jsx)("tr", { children: i.headers.map((o) => (0, import_jsx_runtime.jsxs)("th", {
			colSpan: o.colSpan,
			className: `border-b border-border ${a} align-middle relative group transition-colors`,
			style: { width: o.getSize() },
			children: [(0, import_jsx_runtime.jsxs)("div", {
				className: `flex items-center justify-between cursor-pointer select-none hover:text-foreground transition-colors ${o.column.getCanSort() ? "group-hover:text-primary" : ""}`,
				onClick: o.column.getToggleSortingHandler(),
				children: [(0, import_jsx_runtime.jsx)("span", {
					className: "truncate",
					children: flexRender(o.column.columnDef.header, o.getContext())
				}), o.column.getCanSort() && (0, import_jsx_runtime.jsxs)("div", {
					className: "ml-2 flex flex-col text-[8px] opacity-50 group-hover:opacity-100 transition-opacity",
					children: [(0, import_jsx_runtime.jsx)("span", {
						className: o.column.getIsSorted() === "asc" ? "text-primary font-bold" : "",
						children: "▲"
					}), (0, import_jsx_runtime.jsx)("span", {
						className: o.column.getIsSorted() === "desc" ? "text-primary font-bold" : "",
						children: "▼"
					})]
				})]
				...
				className: "absolute right-0 top-0 h-full w-1 cursor-col-resize bg-primary/0 hover:bg-primary/50 transition-colors group-hover:bg-primary/20"
			})]
		}, o.id)) }, i.id))
	});
};
var oe = ({ row: e, actions: t }) => {
	let [a, i] = import_react.useState(false);
	return (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [(0, import_jsx_runtime.jsx)("button", {
			...
			"aria-expanded": a,
			children: "⋮"
		}), a && (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("div", {
			className: "fixed inset-0 z-10",
			onClick: () => i(false)
		}), (0, import_jsx_runtime.jsx)("div", {
			className: "absolute right-0 mt-1 w-48 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded shadow-lg z-20 py-1",
			children: t.map((o, n) => (0, import_jsx_runtime.jsx)("button", {
				disabled: o.disabled,
				onClick: () => {
					o.onClick(e.original), i(false);
				},
...
var re = ({ table: e, onRowClick: t, onRowDoubleClick: a, rowActions: i }) => {
	let { density: o } = x(), n = b.DENSITY_CLASSES[o];
	return (0, import_jsx_runtime.jsx)("tbody", {
		className: "divide-y divide-border",
		children: e.getRowModel().rows.map((s) => (0, import_jsx_runtime.jsxs)("tr", {
			onClick: () => t?.(s.original),
			onDoubleClick: () => a?.(s.original),
			className: `transition-colors cursor-pointer group ${s.getIsSelected() ? "bg-primary/10 dark:bg-primary/20" : "hover:bg-muted/50 dark:hover:bg-slate-800/50"}`,
			role: "row",
			"aria-selected": s.getIsSelected(),
			children: [s.getVisibleCells().map((c) => (0, import_jsx_runtime.jsx)("td", {
				className: `border-r border-border/50 last:border-r-0 ${n} text-sm text-foreground/80 transition-colors group-hover:text-foreground`,
				role: "cell",
				children: flexRender(c.column.columnDef.cell, c.getContext())
			}, c.id)), i && i.length > 0 && (0, import_jsx_runtime.jsx)("td", {
				className: `border-l border-border/50 ${n} text-center`,
				children: (0, import_jsx_runtime.jsx)(oe, {
					row: s,
					actions: i
				})
			})]
...
var ie = ({ table: e, onRowClick: t, onRowDoubleClick: a }) => {
	let { density: i } = x(), o = b.DENSITY_CLASSES[i], { rows: n } = e.getRowModel(), s = import_react.useRef(null), c = useVirtualizer({
		count: n.length,
	...
	return (0, import_jsx_runtime.jsx)("div", {
		...
		children: (0, import_jsx_runtime.jsx)("div", {
			...
			children: c.getVirtualItems().map((C) => {
				let u = n[C.index];
				return (0, import_jsx_runtime.jsx)("tr", {
					onClick: () => t?.(u.original),
					onDoubleClick: () => a?.(u.original),
					className: `${b.ZEBRA_STRIPE_CLASS} ${b.HOVER_CLASS} cursor-pointer ${u.getIsSelected() ? "bg-blue-50 dark:bg-slate-800" : ""}`,
					style: {
						position: "absolute",
						top: 0,
					...
					children: u.getVisibleCells().map((p) => (0, import_jsx_runtime.jsx)("td", {
						className: `border-r border-gray-100 dark:border-slate-700 last:border-r-0 ${o} flex-1`,
						style: { width: p.column.getSize() },
						children: import_react.default.flexRender(p.column.columnDef.cell, p.getContext())
					}, p.id))
				}, u.id);
			})
		})
...
var ne = ({ table: e }) => (0, import_jsx_runtime.jsxs)("div", {
	className: "flex items-center justify-between px-4 py-3 bg-background border-t border-border text-sm text-muted-foreground font-medium",
	children: [(0, import_jsx_runtime.jsxs)("div", {
		className: "flex items-center gap-2",
		children: [
			(0, import_jsx_runtime.jsx)("span", {
		...
		children: [(0, import_jsx_runtime.jsx)("select", {
			...
			className: "bg-background border border-input rounded-md px-2 py-1 text-xs focus:ring-2 focus:ring-primary outline-none transition-all",
			children: [
				10,
				20,
				50,
			...
			children: [(0, import_jsx_runtime.jsx)("button", {
				...
				className: "px-3 py-1.5 border border-input rounded-md disabled:opacity-40 hover:bg-muted transition-colors text-xs font-medium",
				children: "Previous"
...
var le = ({ table: e }) => (0, import_jsx_runtime.jsxs)("div", {
	className: "absolute right-4 top-12 z-20 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-md shadow-lg p-2 w-48",
	children: [(0, import_jsx_runtime.jsx)("p", {
		className: "text-xs font-bold mb-2 px-2 text-gray-500 uppercase",
		children: "Toggle Columns"
	}), (0, import_jsx_runtime.jsx)("div", {
		className: "flex flex-col gap-1 max-h-60 overflow-auto",
		children: e.getAllLeafColumns().map((t) => (0, import_jsx_runtime.jsxs)("label", {
			className: "flex items-center gap-2 px-2 py-1 hover:bg-gray-100 dark:hover:bg-slate-700 cursor-pointer text-sm text-gray-700 dark:text-slate-300",
			children: [(0, import_jsx_runtime.jsx)("input", {
				type: "checkbox",
				className: "rounded border-gray-300 text-blue-600 focus:ring-blue-500",
				checked: t.getIsVisible(),
				onChange: t.getToggleVisibilityHandler()
			}), String(t.columnDef.header)]
		}, t.id))
	})]
});
var de = ({ table: e, searchable: t, filterable: a, exportable: i }) => {
	let [o, n] = import_react.useState(false);
	return (0, import_jsx_runtime.jsxs)("div", {
		className: "flex items-center justify-between px-4 py-3 bg-background border-b border-border gap-4 relative",
		children: [
			(0, import_jsx_runtime.jsx)("div", {
				className: "flex items-center gap-2",
				children: t && (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [(0, import_jsx_runtime.jsx)("div", {
						...
						onChange: (s) => e.setGlobalFilter(s.target.value),
						className: "pl-9 pr-4 py-2 text-sm border border-input rounded-lg w-64 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-background transition-all"
					})]
				})
			}),
			(0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					a && (0, import_jsx_runtime.jsx)("button", {
						...
						className: "px-3 py-2 text-xs font-medium border border-input rounded-lg hover:bg-muted transition-colors",
					...
					(0, import_jsx_runtime.jsx)("button", {
						className: "px-3 py-2 text-xs font-medium bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-all active:scale-95 shadow-sm",
						children: "Add Record"
					})
				]
			}),
			o && (0, import_jsx_runtime.jsx)(le, { table: e })
		]
	});
};
var ce = ({ customLoadingState: e }) => (0, import_jsx_runtime.jsx)("div", {
	className: "flex items-center justify-center h-64 w-full",
	children: e || (0, import_jsx_runtime.jsxs)("div", {
		className: "flex flex-col items-center gap-2",
		children: [(0, import_jsx_runtime.jsx)("div", { className: "w-8 h-8 border-4 border-blue-600 border-t-transparent rounded-full animate-spin" }), (0, import_jsx_runtime.jsx)("p", {
			className: "text-sm text-gray-500",
			children: "Loading data..."
		})]
	})
});
var me = ({ customEmptyState: e }) => (0, import_jsx_runtime.jsx)("div", {
	className: "flex items-center justify-center h-64 w-full",
...
var ge = ({ error: e, customErrorState: t }) => (0, import_jsx_runtime.jsx)("div", {
	className: "flex items-center justify-center h-64 w-full",
	children: t || (0, import_jsx_runtime.jsxs)("div", {
...
var ue = ({ table: e, actions: t, onBulkAction: a }) => {
	let i = e.getSelectedRowModel().rows.map((o) => o.original);
	return i.length === 0 ? null : (0, import_jsx_runtime.jsxs)("div", {
		className: "flex items-center justify-between px-4 py-2 bg-primary/5 border-b border-primary/20 backdrop-blur-sm transition-all animate-in slide-in-from-top-2 duration-200",
		children: [(0, import_jsx_runtime.jsxs)("div", {
			...
			children: [(0, import_jsx_runtime.jsx)("span", {
				...
				children: "rows selected"
			})]
		}), (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center gap-2",
			children: [t.map((o, n) => (0, import_jsx_runtime.jsx)("button", {
				onClick: () => a(o, i),
				className: `px-3 py-1.5 text-xs font-medium rounded-md border transition-all active:scale-95 ${o.danger ? "bg-destructive/10 text-destructive border-destructive/20 hover:bg-destructive hover:text-destructive-foreground" : "bg-background text-foreground border-input hover:bg-accent hover:text-accent-foreground"}`,
				children: o.label
			}, n)), (0, import_jsx_runtime.jsx)("button", {
				onClick: () => e.getToggleAllRowsSelectedHandler()(),
...
var pe = ({ rowCount: e = 10, colCount: t, density: a }) => {
	let i = {
		compact: "h-8",
		comfortable: "h-12",
		spacious: "h-16"
	...
	return (0, import_jsx_runtime.jsx)("div", {
		...
		children: Array.from({ length: e }).map((o, n) => (0, import_jsx_runtime.jsx)("div", {
			className: `flex w-full border-b border-gray-100 dark:border-slate-800 ${i}`,
			children: Array.from({ length: t }).map((s, c) => (0, import_jsx_runtime.jsx)("div", { className: "flex-1 bg-gray-200 dark:bg-slate-700 rounded-sm mx-2 my-2" }, c))
		}, n))
	});
};
function Ke({ data: e, columns: t, loading: a, error: i, emptyState: o, loadingState: n, errorState: s, searchable: c, filterable: C, pagination: u, selectable: p, toolbar: T, stickyHeader: M, virtualized: h, manualPagination: L, manualSorting: G, manualFiltering: z, onRowClick: y, onRowDoubleClick: F, onSelectionChange: A, onSortChange: H, onFilterChange: P, onPaginationChange: g, className: be }) {
	let { state: m, setSorting: xe, setColumnFilters: ye, setGlobalFilter: ve, setColumnVisibility: Se, setRowSelection: Ce, setPagination: he, density: we } = x(), [N, q] = (0, import_react.useState)(false);
	(0, import_react.useEffect)(() => {
		let r = (d) => {
			d.key === "Escape" && N && q(false);
		};
		return window.addEventListener("keydown", r), () => window.removeEventListener("keydown", r);
	}, [N]);
	let Q = (0, import_react.useMemo)(() => p ? [{
		id: "selection",
		header: ({ table: r }) => (0, import_jsx_runtime.jsx)("input", {
			type: "checkbox",
			className: "rounded border-gray-300 text-blue-600 focus:ring-blue-500",
			checked: r.getIsAllPageRowsSelected(),
			onChange: r.getToggleAllPageRowsSelectedHandler(),
			indeterminate: r.getIsSomePageRowsSelected()
		}),
		cell: ({ row: r }) => (0, import_jsx_runtime.jsx)("input", {
			type: "checkbox",
			className: "rounded border-gray-300 text-blue-600 focus:ring-blue-500",
		...
		size: 40
	}, ...t] : t, [t, p]), w = useReactTable({
		data: e,
		columns: Q,
		state: {
			sorting: m.sorting,
			columnFilters: m.columnFilters,
		...
		onSortingChange: (r) => {
			let d = typeof r == "function" ? r(m.sorting) : r;
			xe(d), H?.(d);
		},
		onColumnFiltersChange: (r) => {
			let d = typeof r == "function" ? r(m.columnFilters) : r;
			ye(d), P?.(d, m.globalFilter);
		},
		onGlobalFilterChange: (r) => {
			let d = typeof r == "function" ? r(m.globalFilter) : r;
			ve(d), P?.(m.columnFilters, d);
		},
		onColumnVisibilityChange: (r) => {
			let d = typeof r == "function" ? r(m.columnVisibility) : r;
			Se(d);
		},
		onRowSelectionChange: (r) => {
			let d = typeof r == "function" ? r(m.rowSelection) : r;
			Ce(d), A?.(d);
		},
		onPaginationChange: (r) => {
			let d = typeof r == "function" ? r(m.pagination) : r;
			he(d), g?.(d);
		},
	...
	return i ? (0, import_jsx_runtime.jsx)(ge, {
		error: i,
		customErrorState: s
	}) : a ? (0, import_jsx_runtime.jsx)(ce, { customLoadingState: n || (0, import_jsx_runtime.jsx)(pe, {
		colCount: Q.length,
		density: we
	}) }) : e.length === 0 ? (0, import_jsx_runtime.jsx)(me, { customEmptyState: o }) : (0, import_jsx_runtime.jsxs)("div", {
		className: `flex flex-col w-full h-full transition-all duration-300 ease-in-out ${N ? "fixed inset-0 z-50 bg-background p-6 animate-in zoom-in-95" : `rounded-xl border border-border bg-background shadow-sm overflow-hidden ${be}`}`,
		children: [
			(0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center justify-between bg-background",
				children: [T && (0, import_jsx_runtime.jsx)(de, {
					table: w,
					searchable: c,
					filterable: C
				}), (0, import_jsx_runtime.jsx)("button", {
					onClick: () => q(!N),
					className: "p-3 text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-colors mr-2",
					...
					children: (0, import_jsx_runtime.jsx)("svg", {
						...
						strokeLinecap: "round",
						strokeLinejoin: "round",
						children: N ? (0, import_jsx_runtime.jsx)("path", { d: "M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7" }) : (0, import_jsx_runtime.jsx)("path", { d: "M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16V19a2 2 0 0 0 2 2h3" })
					})
				})]
			}),
			p && (0, import_jsx_runtime.jsx)(ue, {
				table: w,
				actions: [],
				onBulkAction: () => {}
			}),
			(0, import_jsx_runtime.jsx)("div", {
				className: `relative overflow-auto ${M ? "max-h-full" : ""}`,
				children: (0, import_jsx_runtime.jsxs)("table", {
					className: "w-full text-left border-collapse",
					children: [(0, import_jsx_runtime.jsx)(te, { table: w }), h ? (0, import_jsx_runtime.jsx)(ie, {
						table: w,
						onRowClick: y,
						onRowDoubleClick: F
			...
			u && (0, import_jsx_runtime.jsx)(ne, { table: w })
		]
	});
}
function oo({ ...e }) {
	return (0, import_jsx_runtime.jsx)(ee, {
		...
		children: (0, import_jsx_runtime.jsx)(Ke, { ...e })
	});
}
//#endregion
